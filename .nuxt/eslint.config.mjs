...
import typegen from '../node_modules/.pnpm/eslint-typegen@0.3.2_eslint@9.17.0_jiti@2.4.2_/node_modules/eslint-typegen/dist/index.mjs';
import { createConfigForNuxt, defineFlatConfigs, resolveOptions } from '../node_modules/.pnpm/@nuxt+eslint-config@0.7.4_@vue+compiler-sfc@3.5.13_eslint@9.17.0_jiti@2.4.2__typescript@5.7.3/node_modules/@nuxt/eslint-config/dist/flat.mjs';
...
export const options = resolveOptions({
  ...
  dirs: {
    ...
    components: ["components", "node_modules/@rds-vue-ui"],
    componentsPrefixed: [],
    layouts: ["layouts"],
    plugins: ["plugins"],
